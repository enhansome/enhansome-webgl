...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,843 | 🐛 237 | 🌐 HTML | 📅 2026-08-21 - Spec or Conformance related bugs
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,057 | 🐛 7 | 🌐 C++ | 📅 2026-08-22 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) ⭐ 2,843 | 🐛 237 | 🌐 HTML | 📅 2026-08-21 - Source code to both view and contribute.
...
* [Hilo3d](https://github.com/hiloteam/Hilo3d) ⭐ 662 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-22 - WebGL rendering engine for 3D games.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,048 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,749 | 🐛 105 | 📅 2026-08-21 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,175 | 🐛 14 | 🌐 Markdown | 📅 2026-08-17 - Awesome list about game development.
