...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,858 | 🐛 237 | 🌐 HTML | 📅 2026-09-14 - Spec or Conformance related bugs
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,072 | 🐛 7 | 🌐 C++ | 📅 2026-09-15 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) ⭐ 2,858 | 🐛 237 | 🌐 HTML | 📅 2026-09-14 - Source code to both view and contribute.
...
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,281 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - 2D physics engine for cross-platform HTML5 game development.
* [p2.js](https://github.com/schteppe/p2.js) ⭐ 2,688 | 🐛 106 | 🌐 JavaScript | 📅 2022-07-09 - 2D rigid body physics engine written in JavaScript.
* [Stage.js](https://github.com/shakiba/stage.js) ⭐ 2,569 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-07 - 2D Library for cross-platform HTML5 game development.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,078 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,216 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,306 | 🐛 15 | 🌐 Markdown | 📅 2026-09-14 - Awesome list about game development.
* [glTF](https://github.com/KhronosGroup/glTF) ⭐ 7,840 | 🐛 317 | 🌐 HTML | 📅 2026-09-12 - Runtime 3D Asset Delivery designed for the web.
