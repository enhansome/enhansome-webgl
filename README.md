...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,859 | 🐛 240 | 🌐 HTML | 📅 2026-09-14 - Spec or Conformance related bugs
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,083 | 🐛 7 | 🌐 C++ | 📅 2026-09-23 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) ⭐ 2,859 | 🐛 240 | 🌐 HTML | 📅 2026-09-14 - Source code to both view and contribute.
...
* [Khronos Dev Tools](https://github.com/KhronosGroup/WebGLDeveloperTools) ⭐ 222 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-21 - Useful WebGL developer tools, intended to be used as an ES6 module.
...
> [More detailed information about the different libraries can be found in the Libraries directory.](https://github.com/sjfricke/awesome-webgl/tree/master/Libraries) ⭐ 1,536 | 🐛 18 | 📅 2026-04-02

### 2D

* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,283 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-22 - 2D physics engine for cross-platform HTML5 game development.
...
* [Hilo3d](https://github.com/hiloteam/Hilo3d) ⭐ 666 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-22 - WebGL rendering engine for 3D games.
* [GLBoost](https://github.com/emadurandal/GLBoost) ⭐ 108 | 🐛 56 | 🌐 JavaScript | 📅 2025-05-19 - Rendering library for 3D graphic geeks.
* [GrimoireGL](https://grimoire.gl/) - Bridge between Web engineers and CG engineers.

### Physics

* [Ammo.js](https://github.com/kripken/ammo.js/) ⭐ 4,572 | 🐛 175 | 🌐 C++ | 📅 2026-09-22 - Direct port of the Bullet physics engine to JavaScript using Emscripten.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,085 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
* [Lightgl.js](https://github.com/evanw/lightgl.js) ⭐ 1,574 | 🐛 18 | 🌐 JavaScript | 📅 2022-08-25 - Lightweight and explict library to help prototype.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,213 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,351 | 🐛 18 | 🌐 Markdown | 📅 2026-09-14 - Awesome list about game development.
* [glTF](https://github.com/KhronosGroup/glTF) ⭐ 7,846 | 🐛 317 | 🌐 HTML | 📅 2026-09-21 - Runtime 3D Asset Delivery designed for the web.
...
Please see [CONTRIBUTING](https://github.com/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md) ⭐ 1,536 | 🐛 18 | 📅 2026-04-02 for details.
