...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,856 | 🐛 237 | 🌐 HTML | 📅 2026-09-05 - Spec or Conformance related bugs
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,069 | 🐛 7 | 🌐 C++ | 📅 2026-09-10 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) ⭐ 2,856 | 🐛 237 | 🌐 HTML | 📅 2026-09-05 - Source code to both view and contribute.
...
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,278 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - 2D physics engine for cross-platform HTML5 game development.
...
* [Hilo3d](https://github.com/hiloteam/Hilo3d) ⭐ 664 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-08 - WebGL rendering engine for 3D games.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,071 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,681 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,273 | 🐛 14 | 🌐 Markdown | 📅 2026-09-01 - Awesome list about game development.
