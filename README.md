...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,084 | 🐛 7 | 🌐 C++ | 📅 2026-09-24 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
...
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,284 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-22 - 2D physics engine for cross-platform HTML5 game development.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,087 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,684 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,357 | 🐛 16 | 🌐 Markdown | 📅 2026-09-23 - Awesome list about game development.
* [glTF](https://github.com/KhronosGroup/glTF) ⭐ 7,844 | 🐛 317 | 🌐 HTML | 📅 2026-09-21 - Runtime 3D Asset Delivery designed for the web.
