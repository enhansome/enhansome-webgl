...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,843 | 🐛 237 | 🌐 HTML | 📅 2026-08-11 - Spec or Conformance related bugs
...
* [GLSLbin](http://glslb.in) - Fragment shader sandbox supporting [glslify](https://github.com/glslify/glslify) ⭐ 2,283 | 🐛 63 | 🌐 JavaScript | 📅 2022-06-29.
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,057 | 🐛 7 | 🌐 C++ | 📅 2026-08-13 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) ⭐ 2,843 | 🐛 237 | 🌐 HTML | 📅 2026-08-11 - Source code to both view and contribute.
...
* [Khronos Dev Tools](https://github.com/KhronosGroup/WebGLDeveloperTools) ⭐ 221 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-20 - Useful WebGL developer tools, intended to be used as an ES6 module.
...
* [WebGL 2 & GLSL Primer: A Zero-to-Hero, Spaced-Repetition Guide](https://github.com/GregStanton/webgl2-glsl-primer) ⭐ 73 | 🐛 0 | 📅 2026-08-12 - Grok WebGL2 and GLSL through a sequence of guided lessons, each chunked into atomic Q\&A cards, with hands-on projects and solution code integrated throughout.
...
> [More detailed information about the different libraries can be found in the Libraries directory.](https://github.com/sjfricke/awesome-webgl/tree/master/Libraries) ⭐ 1,525 | 🐛 11 | 📅 2026-04-02

### 2D

* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,265 | 🐛 31 | 🌐 TypeScript | 📅 2026-04-07 - 2D physics engine for cross-platform HTML5 game development.
...
* [Phenomenon](https://github.com/vaneenige/phenomenon) ⭐ 1,840 | 🐛 3 | 🌐 TypeScript | 📅 2023-11-10 - Very small, low-level WebGL library that provides the essentials to deliver a high performance experience.
...
* [Hilo3d](https://github.com/hiloteam/Hilo3d) ⭐ 662 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-13 - WebGL rendering engine for 3D games.
...
* [Ammo.js](https://github.com/kripken/ammo.js/) ⭐ 4,550 | 🐛 175 | 🌐 C++ | 📅 2026-06-16 - Direct port of the Bullet physics engine to JavaScript using Emscripten.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,040 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 495,058 | 🐛 100 | 📅 2026-06-30 - Curated list of awesome lists.
...
* [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,431 | 🐛 0 | 📅 2026-01-09 - Curated list of awesome OpenGL libraries, debuggers and resources. Inspired by awesome-... stuff.
* [graphics-resources](https://github.com/mattdesl/graphics-resources) ⭐ 1,853 | 🐛 5 | 📅 2020-12-30 - List of graphic programming resources.

## Contributing

Please see [CONTRIBUTING](https://github.com/sjfricke/awesome-webgl/blob/master/CONTRIBUTING.md) ⭐ 1,525 | 🐛 11 | 📅 2026-04-02 for details.
