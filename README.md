...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,064 | 🐛 7 | 🌐 C++ | 📅 2026-08-31 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
...
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,276 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - 2D physics engine for cross-platform HTML5 game development.
...
* [Hilo3d](https://github.com/hiloteam/Hilo3d) ⭐ 662 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-31 - WebGL rendering engine for 3D games.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,059 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,608 | 🐛 105 | 📅 2026-08-21 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,222 | 🐛 15 | 🌐 Markdown | 📅 2026-08-29 - Awesome list about game development.
* [glTF](https://github.com/KhronosGroup/glTF) ⭐ 7,828 | 🐛 329 | 🌐 HTML | 📅 2026-08-30 - Runtime 3D Asset Delivery designed for the web.
