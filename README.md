...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,848 | 🐛 237 | 🌐 HTML | 📅 2026-08-28 - Spec or Conformance related bugs
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,066 | 🐛 7 | 🌐 C++ | 📅 2026-09-04 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) ⭐ 2,848 | 🐛 237 | 🌐 HTML | 📅 2026-08-28 - Source code to both view and contribute.
...
* [Hilo3d](https://github.com/hiloteam/Hilo3d) ⭐ 663 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-02 - WebGL rendering engine for 3D games.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,062 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,863 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,250 | 🐛 14 | 🌐 Markdown | 📅 2026-09-01 - Awesome list about game development.
* [glTF](https://github.com/KhronosGroup/glTF) ⭐ 7,836 | 🐛 329 | 🌐 HTML | 📅 2026-09-03 - Runtime 3D Asset Delivery designed for the web.
