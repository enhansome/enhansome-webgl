...
* [Khronos Github Issue Page](https://github.com/KhronosGroup/WebGL/issues) ⭐ 2,858 | 🐛 238 | 🌐 HTML | 📅 2026-09-05 - Spec or Conformance related bugs
...
* [Google Project ANGLE](https://github.com/google/angle) ⭐ 4,070 | 🐛 7 | 🌐 C++ | 📅 2026-09-14 - Default WebGL backend for both Google Chrome and Mozilla Firefox on Windows platforms.
* [WebGL Source Code](https://github.com/KhronosGroup/WebGL) ⭐ 2,858 | 🐛 238 | 🌐 HTML | 📅 2026-09-05 - Source code to both view and contribute.
...
* [Planck.js](https://github.com/shakiba/planck.js) ⭐ 5,280 | 🐛 32 | 🌐 TypeScript | 📅 2026-04-07 - 2D physics engine for cross-platform HTML5 game development.
...
* [Hilo3d](https://github.com/hiloteam/Hilo3d) ⭐ 664 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-12 - WebGL rendering engine for 3D games.
...
* [Turbulenz](https://github.com/turbulenz/turbulenz_engine) ⭐ 5,079 | 🐛 39 | 🌐 TypeScript | 📅 2023-05-28 - Modular 3D and 2D game framework for making HTML5 powered games for browsers, desktops and mobile devices.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 505,935 | 🐛 106 | 📅 2026-09-02 - Curated list of awesome lists.
* [gamedev](https://github.com/ellisonleao/magictools) ⭐ 17,301 | 🐛 15 | 🌐 Markdown | 📅 2026-09-14 - Awesome list about game development.
...
* [awesome-opengl](https://github.com/eug/awesome-opengl) ⭐ 2,439 | 🐛 0 | 📅 2026-01-09 - Curated list of awesome OpenGL libraries, debuggers and resources. Inspired by awesome-... stuff.
